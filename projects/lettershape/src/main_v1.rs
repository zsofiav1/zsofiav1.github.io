...
pub fn get_valid_words_v0(words: &Vec<String>, permutations: &Vec<String>, letters_flat: &Vec<char>) -> io::Result<Vec<String>> {
...
fn main() -> result::Result<(), Box<dyn error::Error>> {
    ...
    // filter words
    // let valid_words = get_valid_words_v0(&words, &invalid_permutations, &letters_flat)?;
